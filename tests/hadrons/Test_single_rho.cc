...
#include <Grid/Hadrons/Modules/MContraction/SingleRho.hpp>
#include <ctime>
...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    MContraction::SingleRho::Par mesPar;
    ...
    mesPar.output = "singlerho/pt_" + flavour + "_" + current_time; 
    mesPar.q1     = "Qpt_" + flavour;
    application.createModule<MContraction::SingleRho>("singlerho_pt_"
                                                      + flavour,
                                                      mesPar);
    
    // execution
    application.saveParameterFile("SingleRho.xml");
    application.run();
